...
function turnOnLights() {
    ...
    // Pehla music yahan se shuru karein
    const lightsSong = document.getElementById('lightsSong');
    if (lightsSong) {
        lightsSong.play();
        lightsSong.loop = true;
    }
}
...
function happyBirthday() {
    ...
    // Pehle music ko band karein
    const lightsSong = document.getElementById('lightsSong');
    if (lightsSong) {
        lightsSong.pause();
        lightsSong.currentTime = 0; // Gaane ko shuruat mein wapas le jayenge
    }
    ...
    // Dusra gaana aur confetti chalayein
